...
Button(frame, width=19, pady=7, text='Sign in', bg='#57a1f8', fg='white', border=0).place(x=23, y=254)

Button(frame, width=19, pady=7, text='Sign up', bg='#57a1f8', fg='white', border=0).place(x=185, y=254)

# create help link for sign in issues
help_img = PhotoImage(file='dot.png')
Label(root, image=help_img, bg='white').place(x=520, y=379)

label = Label(frame, text="Need help signing in?", fg='#57a1f8', bg='white', font=('Microsoft YaHei UI Light', 11))
label.place(x=95, y=320)
